...
namespace Voice
{
    public class MumbleService : MonoBehaviour {
        ...
        private MumbleAudioPlayer CreateMumbleAudioPlayerFromPrefab(string username, uint session)
        {
            ...
            newObj.GetComponentInChildren<MeshRenderer>().materials[0].color = Random.ColorHSV(0f, 1f, 1f, 1f, 0.5f, 1f);
